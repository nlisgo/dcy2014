Drupalcamp Yorkshire 2014 Controller Module
=====================
...
Here is an example of how to enable the Rules module by using the update hook in the dcy2014_controller.install file:

/**
 * Enabling Rules module
 */
function dcy2014_controller_update_7000()
{
  $modules = array('rules');
